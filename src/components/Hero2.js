        ...
        <div className="container grid grid-cols-2 gap-20">
                    ...
                    <div id="hero2" className="flex flex-col lg:flex-row py-10 justify-between text-center lg:text-left">
                        <div className="lg:w-2/2 flex flex-col justify-center mt-9 align-middle">
                            ...
                            <div className="space-x-0 md:space-x-2 md:mb-8 mb-10">
                                <HashLink to="/buyer" className="text-black border border-solid border-black hover:bg-[#57d08e] inline-flex items-center justify-center w-auto px-5 py-2 shadow-xl rounded-xl" smooth>
                                    Become Buyer
                                </HashLink>
                                <HashLink to="/landlord" className="text-black border border-solid border-black hover:bg-[#57d08e] inline-flex items-center justify-center w-auto px-5 py-2 shadow-xl rounded-xl" smooth>
                                    Become Landlord
                                </HashLink>
                            </div>
                        </div>
            ...
            <div className="hero-right relative" id="hero-right">
                <div className="w-full relative" data-aos-delay="700">
                    ...
                    <img src="neomorph-right.png" className="absolute w-[70px] top-[420px] right-4 backdrop-blur-sm" alt="neomorph-right" />
                    <img src="neomorph-left.png" className="absolute w-[241px] top-[420px] right-28 backdrop-blur-sm" alt="neomorph-left" />
                    <div>
