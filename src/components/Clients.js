            ...
            <section data-aos="fade-up">
                ...
                <div className="p-16" data-aos="fade-in" data-aos-delay="600">
                    <div className="grid sm:grid-cols-3 lg:grid-cols-3">
                        <ClientImage src={kws} alt="KWS" />
                        <ClientImage src={protergia} alt="Protergia" />
                        <ClientImage src={geps} alt="GEPS" />
                    </div>
                </div>
            </section>
        </div>
...
const ClientImage = ({ src, alt }) => {
    return (
        <div style={clientImageStyle} className="overflow-hidden p-3 flex justify-center transition-all ease-in-out opacity-50 hover:opacity-100">
            <img src={src} alt={alt} />
        </div>
    );
};
