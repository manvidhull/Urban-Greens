    ...
    return (
        <div>
            ...
            {currentAccount ? (
                ...
                <div id="connectWalletButton" className="text-white bg-green-600 ml-2 hover:bg-green-600 inline-flex items-center justify-center w-auto px-5 py-2 shadow-xl rounded-xl" onClick={connectWallet}>
                    Connect Wallet
                </div>
            )}
        </div>
